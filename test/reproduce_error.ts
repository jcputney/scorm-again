...
console.log(
  `Is correct: ${errorCode === String(scorm2004_errors.TYPE_MISMATCH)}`,
);
...
console.log(
  `Is correct: ${errorCode === String(scorm2004_errors.VALUE_OUT_OF_RANGE)}`,
);
...
console.log(
  `Is TYPE_MISMATCH: ${errorCode === String(scorm2004_errors.TYPE_MISMATCH)}`,
);
console.log(
  `Is VALUE_OUT_OF_RANGE: ${errorCode === String(scorm2004_errors.VALUE_OUT_OF_RANGE)}`,
);
...
console.log(
  `Is correct: ${errorCode === String(scorm2004_errors.UNDEFINED_DATA_MODEL)}`,
);
