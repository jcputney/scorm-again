    ...
    describe('CMI Spec Tests', () => {
        describe('Pre-Initialize Tests', () => {
            ...
            h.checkValidValues({
                ...
                validValues: scorm12Values.valid0To100Range.concat([
                    '-1',
                ]),
        ...
        describe('CMITriesObject Tests', () => {
            ...
            h.checkValidValues({
                cmi: triesObject(),
                fieldName: 'cmi.status',
                validValues: scorm12Values.validLessonStatus.concat([
                    'not attempted',
                ]),
                invalidValues: scorm12Values.invalidLessonStatus,
            });
            ...
            it('should export JSON', () => {
                ...
                expect(
                    JSON.stringify(cmi),
                ).toEqual('{"status":"","time":"","score":{"raw":"","min":"","max":"100"}}');
            });
        });
