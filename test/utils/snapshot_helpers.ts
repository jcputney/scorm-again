 ...
 */
export const createSnapshot = (obj: any, options: Partial<SnapshotOptions> = {}): string => {
...
export const deleteAllSnapshots = (
  ...
  const testSnapshots = files.filter(
    (file) => file.startsWith(`${testName}.`) && file.endsWith(".snap"),
  );
 ...
 */
export const createSnapshotTester = (testName: string, options: Partial<SnapshotOptions> = {}) => {
  const opts = { ...defaultOptions, ...options };
  ...
  return {
    ...
    expectToMatchSnapshot: (
      ...
      expectToMatchSnapshot(testName, snapshotName, actual, { ...opts, ...snapshotOptions });
    },
    ...
    saveSnapshot: (
      ...
      saveSnapshot(testName, snapshotName, data, { ...opts, ...snapshotOptions });
    },
     ...
     * @returns The loaded snapshot, or undefined if the snapshot doesn't exist
     */
    loadSnapshot: (snapshotName: string, snapshotOptions: Partial<SnapshotOptions> = {}) => {
      return loadSnapshot(testName, snapshotName, { ...opts, ...snapshotOptions });
    },
     ...
     * @returns True if the snapshot was deleted, false if it didn't exist
     */
    deleteSnapshot: (snapshotName: string, snapshotOptions: Partial<SnapshotOptions> = {}) => {
      return deleteSnapshot(testName, snapshotName, { ...opts, ...snapshotOptions });
    },
     ...
     * @returns The number of snapshots deleted
     */
    deleteAllSnapshots: (snapshotOptions: Partial<SnapshotOptions> = {}) => {
      return deleteAllSnapshots(testName, { ...opts, ...snapshotOptions });
    },
  };
};
