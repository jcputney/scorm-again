...
/**
 * Comprehensive integration tests for ContentPackagingOneFilePerSCO_SCORM12 module
 *
 * This module is a multi-SCO module for SCORM 1.2. It differs from SCORM 2004 in that:
 ...
 * - Navigation between SCOs is handled by the LMS
 *
 * Tests cover:
 ...
 * - Multi-SCO content loading
 */

// Module path - uses launchpage.html which should handle navigation
const MODULE_PATH =
  "/test/integration/modules/ContentPackagingOneFilePerSCO_SCORM12/shared/launchpage.html";
...
wrappers.forEach((wrapper) => {
  test.describe(`ContentPackagingOneFilePerSCO SCORM 1.2 Integration (${wrapper.name})`, () => {
