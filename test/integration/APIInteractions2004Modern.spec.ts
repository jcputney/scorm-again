...
/**
 * This file contains integration tests for SCORM 2004 API interactions using the modern build.
...
test.describe("SCORM 2004 API Modern Build Interactions", () => {
  test("should handle basic data model interactions correctly", async ({ page }) => {
    ...
    // Navigate to the SCORM 2004 modern wrapper with the basic calls module
    await page.goto(
      "/test/integration/wrappers/scorm2004-wrapper-modern.html?module=/test/integration/modules/RuntimeBasicCalls_SCORM20043rdEdition/shared/launchpage.html",
    );
  ...
  test("should handle advanced data model interactions", async ({ page }) => {
    // Navigate to the SCORM 2004 modern wrapper with the advanced calls module
    await page.goto(
      "/test/integration/wrappers/scorm2004-wrapper-modern.html?module=/test/integration/modules/RunTimeAdvancedCalls_SCORM20043rdEdition/shared/launchpage.html",
    );
