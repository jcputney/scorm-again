...
export const scorm12Values: Scorm12Values = {
  ...
  invalidSpeedRange: ["invalid", "a100", "-101", "101", "1000"],
  validScoreRange: ["1", "50.25", "70", "100", 1, 50.25, 70, 100],
  invalidScoreRange: ["invalid", "a100", "-1", "101", "1000"],
  invalid0To100Range: ["invalid", "a100", "-2"],
  validTime: ["10:06:57", "23:59:59", "00:00:00", "00:00:01.56"],
  invalidTime: ["47:59:59", "06:5:13", "23:59:59.123", "P1DT23H59M59S"],
  ...
  invalidMasteryScore: ["invalid", "a100", "-1", "101", "1000"],
...
export const scorm2004Values: Scorm2004Values = {
  ...
  invalidType: ["correct", "wrong", "logout"],
  validScoreRange: ["1", "50", "100", "-10000", "-1", "10000", "100000", "-100000"],
  invalidScoreRange: ["invalid", "a100", "12345678901", "-12345678901"],
