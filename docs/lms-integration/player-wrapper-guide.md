# Player Wrapper Integration Guide
...
- [LMS Integration Guide](./lms-integration-guide.md) - Core LMS integration concepts
- [SCORM 1.2 Multi-SCO Guide](./scorm12-multi-sco-guide.md) - Multi-SCO utilities
- [Cross-Frame Communication Guide](./cross-frame-communication.md) - Sandboxed iframe integration
- [Data Requirements Quick Reference](./data-requirements-quick-reference.md) - Data model reference
