# Cross-Frame Communication Guide
...
- [LMS Integration Guide](./lms-integration-guide.md) - Main integration guide
- [API Events Reference](./api-events-reference.md) - All available events
- [Offline Support](../offline_support.md) - Offline capabilities
