...
- **Exit vocabulary** — Similarly, `"normal"` for `cmi.core.exit` is coerced to the empty string so commits remain spec-compliant, with a warning to aid cleanup ([`src/cmi/aicc/core.ts:300-325`](../src/cmi/aicc/core.ts#L300)).[^exit]
