(function (exports) {
  ...
  class CrossFrameAPI {
    ...
    _syncCall(method, params) {
      let timeoutMs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5e3;
      try {
  ...
  exports.createCrossFrameClient = createCrossFrameClient;
  exports.createCrossFrameServer = createCrossFrameServer;

})(this["cross-frame-facade"] = this["cross-frame-facade"] || {});
