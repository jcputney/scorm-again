...
${stackTrace}`);
  ...
  class RollupProcess {
    ...
    measureRollupProcess(activity) {
      ...
      const hasValidMeasures = children.some(c => this.checkChildForRollupSubprocess(c, "measure") && c.objectiveMeasureStatus && c.objectiveNormalizedMeasure !== null);
      if (!hasValidMeasures) {
  ...
  class Scorm2004API extends BaseAPI {
    ...
    createActivity(activitySettings) {
      ...
      if (activitySettings.sequencingControls) {
        ...
        if (c.useCurrentAttemptObjectiveInfo !== void 0) sc.useCurrentAttemptObjectiveInfo = c.useCurrentAttemptObjectiveInfo;
        if (c.useCurrentAttemptProgressInfo !== void 0) sc.useCurrentAttemptProgressInfo = c.useCurrentAttemptProgressInfo;
        ...
        if (c.rollupObjectiveSatisfied !== void 0) sc.rollupObjectiveSatisfied = c.rollupObjectiveSatisfied;
        if (c.rollupProgressCompletion !== void 0) sc.rollupProgressCompletion = c.rollupProgressCompletion;
        if (c.objectiveMeasureWeight !== void 0) sc.objectiveMeasureWeight = c.objectiveMeasureWeight;
      }
