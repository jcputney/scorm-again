...
var CMI = /*#__PURE__*/function (_BaseCMI) {
  ...
  _createClass(CMI, [{
    ...
    ,
    set: function set(session_time) {
      if (this.initialized && check2004ValidFormat(session_time, scorm2004_regex.CMITimespan)) {
        _classPrivateFieldSet(this, _session_time, session_time);
      }
    }
    /**
