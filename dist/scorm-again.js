  ...
  _createClass(BaseAPI, [{
    ...
    value: function loadFromFlattenedJSON(json, CMIElement) {
      ...
      result.sort(function (_ref, _ref2) {
        ...
        var int_id_pattern = /^cmi\.interactions\.(\d+)\.id$/;
        var int_type_pattern = /^cmi\.interactions\.(\d+)\.type$/;
        var int_pattern = /^cmi\.interactions\.(\d+)/;
        var obj_id_pattern = /^cmi\.objectives\.(\d+)\.id$/;
        var obj_pattern = /^cmi\.objectives\.(\d+)/;
        var id_test = testPattern(a, c, int_id_pattern, int_pattern);
