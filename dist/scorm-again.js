      ...
      result.sort(function (_ref, _ref2) {
        ...
        function testPattern(a, c, a_pattern, c_pattern) {
          if (a.match(c_pattern) && c.match(a_pattern)) {
            var a1 = Number(a.match(c_pattern)[1]);
            var c1 = Number(c.match(a_pattern)[1]);
            if (a1 === c1) return -1;else return 1;
          }
