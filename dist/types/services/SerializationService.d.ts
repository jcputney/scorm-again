...
export declare class SerializationService implements ISerializationService {
    loadFromFlattenedJSON(json: StringKeyMap, CMIElement: string, setCMIValue: (CMIElement: string, value: any) => void, isNotInitialized: () => boolean, setStartingData: (data: StringKeyMap) => void): void;
    loadFromJSON(json: {
        [key: string]: any;
    }, CMIElement: string, setCMIValue: (CMIElement: string, value: any) => void, isNotInitialized: () => boolean, setStartingData: (data: StringKeyMap) => void): void;
