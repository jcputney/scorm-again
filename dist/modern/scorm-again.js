(function () {
  ...
  const scorm2004_errors$1 = __spreadProps$3(__spreadValues$4({}, global_errors), {
...
${stackTrace}`);
  ...
  class Scorm12API extends BaseAPI {
    ...
    renderCommitObject(terminateCommit, includeTotalTime = false) {
      ...
      const scoreObject = ((_c = (_b = (_a = this.cmi) == null ? void 0 : _a.core) == null ? void 0 : _b.score) == null ? void 0 : _c.getScoreObject()) || {};
      const commitObject = {
        successStatus,
        completionStatus,
