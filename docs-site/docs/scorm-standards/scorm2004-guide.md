---
sidebar_position: 3
title: SCORM 2004 Guide
description: Comprehensive guide for implementing and using the SCORM 2004 API with practical examples including SCO-side API discovery
---
